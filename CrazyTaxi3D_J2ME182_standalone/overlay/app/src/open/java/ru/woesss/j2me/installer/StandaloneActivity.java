...
/**
 * Standalone launcher for Crazy Taxi 3D.
 * Keeps the stock J2ME Loader 1.8.2 runtime/M3G implementation intact.
 */
public class StandaloneActivity extends MainActivity {
    private static final String ASSET_JAR = "crazytaxi.jar";
    private static final String LOCAL_JAR = "crazytaxi-embedded.jar";
    ...
    private void fatal(Throwable t) {
        t.printStackTrace();
        Toast.makeText(this, "Crazy Taxi: " + t.getClass().getSimpleName() + ": " +
